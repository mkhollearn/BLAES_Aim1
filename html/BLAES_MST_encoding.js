...
function codeDefineImagesRoutineBegin() {
  ...
  for (const thisComponent of codeDefineImagesComponents)
...
function codeSetupVarsRoutineBegin() {
  ...
  for (const thisComponent of codeSetupVarsComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function setupImageListsRoutineBegin() {
  ...
  for (const thisComponent of setupImageListsComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function study_instructions_routineRoutineBegin() {
  ...
  for (const thisComponent of study_instructions_routineComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function study_trialsLoopBegin(thisScheduler) {
  ...
  for (const thisStudy_trial of study_trials) {
...
function codeStudyRoutineBegin() {
  ...
  for (const thisComponent of codeStudyComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
