function param = script_BLAES_Aim1_LongDelay_testphase(settings,ALL_IMAGES,slash,trials,breakoutnum_iter, practice_pairs)
...
for idx_iter = 6501:6500+size(practice_pairs)[0]; 
        ...
        param.Stimuli.Value{2,idx_iter}      = sprintf('%s',fullfile(settings.BCI2000path,'tasks', 'BLAES_Aim1', 'Aim1_LongDelay','practice_images',practice_pairs{idx,1})); %need to change this
        ...
        param.Stimuli.Value{9,idx_iter}      = practice_pairs{idx,3}; %novelty
...
%% Confidence Ratings 5301
conf_images = dir(fullfile(settings.BCI2000path, 'tasks', 'BLAES_Aim1', 'Aim1_LongDelay', 'LongDelay_images_RO','*.PNG'));
c = 1;
...
prac_conf_images = dir(fullfile(settings.BCI2000path, 'tasks', 'BLAES_Aim1', 'Aim1_LongDelay', 'practice_conf_RO','*.PNG'));
