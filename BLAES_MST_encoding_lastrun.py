...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/martinahollearn/Desktop/INMAN LAB/AMME/Aim 1/MST/BLAES_imageset/BLAES_MST_encoding_lastrun.py',
...
with open(f'logs/{participant_id}_exp_info.csv','w+') as f:
    f.write('imgA,imgB,rating,condition,session_id\n')
    for img in all_images_final:
        f.write(','.join([str(i) for i in img]))
        f.write('\n')

study_images = [img for img in all_images_final if img[3] in ('HSim', 'LSim')]
for i in range(len(study_images)):
    study_images[i][0] = f"all_images/{study_images[i][0]}"
...
study_instructions = visual.TextStim(win=win, name='study_instructions',
    ...
    font='Arial',
    pos=(0.5, 0), height=0.025, wrapWidth=None, ori=0, 
...
study_outdoor_selected = visual.ImageStim(
    ...
    image='all_images/outdoor_selected.png', mask=None,
...
study_outdoor = visual.ImageStim(
    win=win,
    name='study_outdoor', 
    image='all_images/outdoor_unselected.png', mask=None,
    ori=0, pos=[0,0], size=1.0,
...
study_indoor_selected = visual.ImageStim(
    ...
    image='all_images/indoor_selected.png', mask=None,
    ori=0, pos=[0,0], size=1.0,
    color=[1,1,1], colorSpace='rgb', opacity=0,
    flipHoriz=False, flipVert=False,
...
study_indoor = visual.ImageStim(
    win=win,
    name='study_indoor', 
    image='all_images/indoor_unselected.png', mask=None,
    ori=0, pos=[0,0], size=1.0,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
